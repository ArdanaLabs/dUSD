...
%   \item The process will snapshot the state of all existing orders from the previous run
%     \todo{determine to what effect this should have on supply adjustment calculations}.
