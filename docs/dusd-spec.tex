...
\todo{What is the config UTXO?}

\todo{Protocol updates.}
...
\todo{Explain the datum of a Config UTXO.}
% Configuration = [Protocol] + price module ID + dUSD currency info
% Protocol = vault script address, buffer ID, protocol-wide parameters ID,
%   auction module ID (optional), "updating vaults to this version" (optional)
