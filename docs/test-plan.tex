...
\subsubsection{Price module authorisation failure}

A non admin tries to create a price module.
This fails.
\todo{What does failure mean? The transaction is not validated?}

\subsubsection{Price module creation success}

An admin creates a price module.
This succeeds.
\todo{What does succeed mean? The transaction is validated?}

\subsubsection{Price module write roundtrip}

When an admin updates price information with any datum, the admin can read the same information in the next read.
