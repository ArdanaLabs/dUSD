{self, ...}: {
  ...
  in {
    packages = {
      hello-world-cbor = hello-world-cbor;
      ...
      hello-world-browser =
        ...
        '';
      hello-world-cli = let
        js = "${hello-world-cli.ps.modules.Main.output {}}/Main/index.js";
      in
        pkgs.writeShellScriptBin "hello-world-cli" ''
    ...
    devShells = let
      commonHelloWorldShell = pkgs.mkShell {
        name = projectName;
        ...
        NODE_PATH = "${npmlock2nix.node_modules {src = ./.;}}/node_modules/";
      };
    in {
      hello-world-browser = commonHelloWorldShell.overrideAttrs (old: {
        buildInputs = old.buildInputs ++ [(hello-world-browser.ps.command {})];
      });
      hello-world-api = commonHelloWorldShell.overrideAttrs (old: {
        buildInputs = old.buildInputs ++ [(hello-world-api.ps.command {})];
      });
    };
  };
  flake = {};
